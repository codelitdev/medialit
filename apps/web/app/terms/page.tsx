    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <p>
                ...
                the use of WebLit&apos;s Website, located at{" "}
                <a href="https://weblit.pro">https://weblit.pro</a>.
            </p>
            <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use WebLit if you do not agree to
            ...
            <p>
                ...
                from Web Audit for your own personal use subjected to
            ...
            <p>
                ...
                website. Web Audit does not filter, edit, publish or review
                messages prior to their presence on the website. Messages do not
                reflect the views and opinions of WebLit,its agents and/or
                affiliates. Messages reflect the views and opinions of the
            ...
            <p>
                WebLit reserves the right to monitor all Messages and to remove
                any Messages which can be considered inappropriate, offensive or
            ...
            <ul>
                <li>
                    {" "}
                    - You are entitled to post the Messages on our website and
                    have all necessary licenses and consents to do so;
                </li>
                <li>
                    {" "}
                    - The Messages do not invade any intellectual property
                    right, including without limitation copyright, patent or
                    trademark of any third party;
                </li>
                <li>
                    {" "}
                    - The Messages do not contain any defamatory, libelous,
                    offensive, indecent or otherwise unlawful material which is
                    an invasion of privacy
                </li>
                <li>
                    {" "}
                    - The Messages will not be used to solicit or promote
            ...
            <p>
                You hereby grant WebLit a non-exclusive license to use,
                reproduce, edit and authorize others to use, reproduce and edit
                any of your messages in any and all forms, formats or media.
            </p>
            ...
            <p>
                ...
                of WebLit; and (d) the link is in the context of general
            ...
            <p>
                ...
                by sending an e-mail to WebLit. Please include your name, your
            ...
            <p>
                No use of WebLit&apos;s logo or other artwork will be allowed

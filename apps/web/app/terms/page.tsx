  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <p>
        ...
        of WebLit&apos;s Website, located at{" "}
        <a href="https://weblit.pro">https://weblit.pro</a>.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use WebLit if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing WebLit, you agreed to use
        cookies in agreement with the WebLit&apos;s Privacy Policy.{" "}
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, WebLit and/or its licensors own the
        intellectual property rights for all material on WebLit. All
        intellectual property rights are reserved. You may access this from Web
        Audit for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li> - Republish material from WebLit</li>
        <li> - Sell, rent or sub-license material from WebLit</li>
        <li> - Reproduce, duplicate or copy material from WebLit</li>
        <li> - Redistribute content from WebLit</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. Web
        Audit does not filter, edit, publish or review messages prior to their
        presence on the website. Messages do not reflect the views and opinions
        of WebLit,its agents and/or affiliates. Messages reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, WebLit shall not be liable for the
        Messages or for any liability, damages or expenses caused and/or
        suffered as a result of any use of and/or posting of and/or appearance
        of the Messages on this website.
      </p>

      <p>
        WebLit reserves the right to monitor all Messages and to remove any
        Messages which can be considered inappropriate, offensive or causes
      ...
      <ul>
        <li>
          {" "}
          - You are entitled to post the Messages on our website and have all
          necessary licenses and consents to do so;
        </li>
        <li>
          {" "}
          - The Messages do not invade any intellectual property right,
          including without limitation copyright, patent or trademark of any
          third party;
        </li>
        <li>
          {" "}
          - The Messages do not contain any defamatory, libelous, offensive,
          indecent or otherwise unlawful material which is an invasion of
          privacy
        </li>
        <li>
          {" "}
          - The Messages will not be used to solicit or promote business or
          custom or present commercial activities or unlawful activity.
        </li>
      </ul>

      <p>
        You hereby grant WebLit a non-exclusive license to use, reproduce, edit
        and authorize others to use, reproduce and edit any of your messages in
      ...
      <p>
        ...
        the hyperlink compensates the absence of WebLit; and (d) the link is in
      ...
      <p>
        ...
        e-mail to WebLit. Please include your name, your organization name,
      ...
      <p>
        No use of WebLit&apos;s logo or other artwork will be allowed for
      ...
      <h2 className="text-lg font-bold">Removal of links from our website</h2>
